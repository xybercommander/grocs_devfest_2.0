    ...
    return Row(
      children: [
        Container(
          ...
          child: Center(
            child: Icon(widget.icon, color: themeData == lightTheme ? widget.color1 : widget.color2,),
          ),
        ),
        SizedBox(width: 12,),
        Text(widget.title, style: TextStyle(fontSize: 18, color: AppColors.lightTheme, fontFamily: 'Nunito-SemiBold'),),
        Spacer(),
        Container(
